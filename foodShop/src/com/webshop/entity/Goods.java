...
public class Goods {
	...
	public String toString() {
		return "Goods [goodsId=" + goodsId + ", goodsName=" + goodsName
				...
				+ ", salesNum=" + salesNum + ", goodsSize=" + goodsSize
				+ ", goodsFrom=" + goodsFrom + ", goodsTime=" + goodsTime
				+ ", goodsSaveCondition=" + goodsSaveCondition
				+ ", goodsDescribe=" + goodsDescribe + ", goodsExplain="
				+ goodsExplain + ", goodsClass=" + goodsClass
				+ ", goodsDiscount=" + goodsDiscount + ", discountStartTime="
				+ discountStartTime + ", discountEndTime=" + discountEndTime
				+ "]";
	}
